...
-- Create the database (Run this command separately if needed, or inside a script that connects to postgres)
-- CREATE DATABASE nexus_siem;

-- Connect to nexus_siem before running the rest
-- \c nexus_siem

-- ==========================================
-- Schema: auth_schema (formerly 'auth' database)
-- ==========================================
...
-- ==========================================
-- Schema: client_schema (formerly 'client-side' database)
-- ==========================================
...
CREATE TABLE IF NOT EXISTS client_schema."Devices" (
    ...
    "Status" VARCHAR, -- Fixed typo from "Status "
    "Os" VARCHAR,
...
CREATE TABLE IF NOT EXISTS client_schema."EVENT" (
    ...
    "Severity" REAL,
    "Description " VARCHAR NOT NULL, -- Kept space if code relies on it, but ideally remove
...
-- ==========================================
-- Schema: server_schema (formerly 'server_side' database)
-- ==========================================
