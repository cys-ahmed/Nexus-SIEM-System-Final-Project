...
const renderRecoveryStatus = (statusMode: string, recovery: number) => {
...
export default function AlertCard({ title, description, severity, time, source, statusMode = "scale", recovery: recoveryProp, onRemove, actions }: AlertCardProps) {
      ...
      <CardContent className="p-4">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 space-y-2">
            ...
            {renderRecoveryStatus(statusMode, recovery)}
            {actions && (
              <div className="mt-2">
                {actions}
              </div>
